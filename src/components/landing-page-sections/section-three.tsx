export default function SectionThree() {
  return (
    <div className="flex flex-col space-y-[50px] items-center justify-start py-[50px] bg-primary-color">
      <div className="w-[60%]">
        <h1 className="text-center font-[800] text-[46px] text-white">
          Trusted by Thousands
        </h1>
        <p className="font-[600] text-[26px] text-[#DBFF9C] text-center">
...
const Stat = ({ figure, description, desc }: StatProps) => {
  return (
    <div className="flex flex-col items-center gap-[10px]">
      <p className="font-[700] text-[39.96px] text-white">{figure}</p>
      <p className="font-[500] text-[18.33px] text-[#DBFF9C]">{description}</p>
      <p className="font-[500] text-[15px] text-[#B3FF2D]">{desc}</p>
    </div>
  );
};
