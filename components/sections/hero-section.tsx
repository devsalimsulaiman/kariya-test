...
export default function HeroSection() {
  return (
    <div className="bg-primary-color h-screen flex flex-col gap-[50px] items-center pt-[120px] max-md:px-[20px]">
      ...
      <div className=" w-full flex justify-center z-20 mt-[2vh] max-md:hidden">
        <Image
